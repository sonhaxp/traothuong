...
import views.QuaTangPanel;
import views.ThongKePanel;
import views.TraoQuaPanel;
...
public class MainController {
    ...
    // set panel for root
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) throws ClassNotFoundException, SQLException {
        ...
        switch(kind) {
                ...
                case "ThongKe":
                    ...
                    break;
                case "QuaTang":
                    view = new QuaTangPanel(this.jfrMain);
                    break;
                case "TraoQua":
                    view = new TraoQuaPanel(this.jfrMain);
                    break;    
                //any more
                default:
                    break;
